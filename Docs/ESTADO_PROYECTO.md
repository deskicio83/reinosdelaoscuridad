...
_Última actualización: S24_fix2 — 2026-04-24_
...
| 🟡 Media | RewardPanel prefab — regenerar | Regenerar con `Tools → Reino Oscuridad → 8. Setup RewardPanel Prefab` para aplicar layout 3 botones (Repetir/Volver/Siguiente). Si ya existe el prefab anterior, regenerarlo añade BtnRepetir y reposiciona los 3 botones. |
